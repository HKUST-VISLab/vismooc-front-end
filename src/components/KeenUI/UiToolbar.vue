    ...
    <div class="ui-toolbar" :class="classes">
        <div class="ui-toolbar__left">
            <div class="ui-toolbar__nav-icon" v-if="!removeNavIcon">
                <slot name="icon">
                    <ui-icon-button size="large" type="secondary" :color="textColor" :icon="navIcon" @click="navIconClick"></ui-icon-button>
                </slot>
            </div>
        ...
        <ui-progress-linear class="ui-toolbar__progress" :color="progressColor" v-show="loading"></ui-progress-linear>
    </div>
</template>
